...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            BaseApp.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        } else {
            BaseApp.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        }
    }
