...
public class ExpandTextView extends AppCompatTextView {
    ...
    private String TEXT_EXPAND = "查看全文";
    ...
    private void initExpandEnd(){
        ...
        SPAN_EXPAND.setSpan(span, 0, content.length(), Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
    }
    ...
    public void setCloseText(CharSequence text) {
        ...
        boolean appendShowAll = true;// true 不需要展开收起功能， false 需要展开收起功能
        ...
        if (maxLines != -1) {
            ...
            if (layout.getLineCount() > maxLines) {
                ...
                while (layout2.getLineCount() > maxLines) {
                    int lastSpace = workingText.length()-50;
                    if (lastSpace == -1) {
                        break;
                    }
